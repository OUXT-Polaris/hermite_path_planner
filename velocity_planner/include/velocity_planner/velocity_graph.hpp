...
public:
  ...
  boost::optional<std::vector<hermite_path_msgs::msg::ReferenceVelocity>> getPlan() const;
...
private:
  void plan();
  std::vector<Node> makeNodes(const hermite_path_msgs::msg::ReferenceVelocity & vel);
